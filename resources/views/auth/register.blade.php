            ...
            <div class="col-sm-4 mt-3 px-3 pt-3 pb-0 animate__animated animate__flipInX">
                ...
                <div class="typewriter-wrapper" id="colElementReg" style="display: none;">
                  <blockquote class="blockquote-fluid mb-0 p-4" {{-- style="width:fit-content;" --}}>
                   ...
                   <footer class="blockquote-footer mt-2">Quote found in Volume 1, Chapter 1, Section 1-1 titled "The Law of Gravitation – An Example of Physical Law" in "The Feynman Lectures on Physics." <cite title="Source title">Richard Feynman</cite></footer>
                  </blockquote>
                </div>
              </div>
