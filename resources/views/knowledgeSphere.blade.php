    ...
    <section class="">
        <div class="container mt-3">
            ...
            <div class="row justify-content-center align-items-center" style="">
                ...
                <div class="col-sm-5 col-md-10 col-lg-6 circleKnowledgeForm order-1 text-center mb-sm-0 mb-md-0 mb-lg-4 mb-0 pt-5 pb-3 animate__animated animate__zoomInDown"
