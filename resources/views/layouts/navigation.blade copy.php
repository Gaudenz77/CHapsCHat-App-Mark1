...
<nav class="navbar navbar-light navbar-expand-md bg-light fixed-top">
  <div class="container-fluid">
  <a class="brand" href="{{  url('/') }}"></a>
    <button class="navbar-toggler border-0 text-light" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">  <!-- data-bs-target="#navbarNavDropdown" -->
            <span class="navbar-toggler-icon"></span>
        </button>
    <div class="collapse navbar-collapse bg-light p-3" id="navbarNavDropdown">
      <img src="./assets/img/Group 26.svg" alt="logo_image" class="img-fluid mt-3">
                  <a class="navbar-brand text-dark" href="{{ url('/') }}">
                      {{ config('app.name', 'CHapsCHat') }} </a>
          <ul class="navbar-nav">  <!-- ms-auto mb-2 mb-md-0 -->
        ...
        <!-- TOGGLE AMAZING START-->
            <!-- <li class="toggle  py-3">
                @include('components.toggle')
                    ...
                    <!-- TOGGLE AMAZING STOP-->
          <li class="nav-item dropdown m-3 m-sm-0">
