...
<x-app-layout>
    <div class="container">
        <div class="row justify-content-evenly text-center">
            <div class="col-sm-6 pt-5 pb-3 circleProfileCols bg-warning mx-1" style="height: 90%;position: relative;top: 6rem;width: 40%;">
                @include('profile.partials.update-profile-information-form')
            </div>

            <div class="col-sm-5 circleProfileCols bg-danger mt-3 mx-1">
                @include('profile.partials.update-password-form')
            </div>

            <div class="col-sm-5 circleProfileCols bg-primary mt-3 mx-1">
